  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (useGraphQL) {
        ...
        const response = await axios.post('https://graphql-travel-book.vercel.app/graphql', { query: mutation });
        ...
        const response = await axios.post('https://graphql-travel-book.vercel.app/bookings', formData);
